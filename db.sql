...
(
    ...
    nombre         varchar(45)            NOT NULL,
    id_departmento varchar(2)             NOT NULL
);
...
VALUES ('01', 'Amazonas'),
    ...
    ('24', 'Tumbes'),
    ('25', 'Ucayali');
INSERT INTO provincias (id, nombre, id_departmento)
VALUES ('0101', 'Chachapoyas', '01'),
    ...
    ('2503', 'Padre Abad ', '25'),
    ('2504', 'Purús', '25');
INSERT INTO distritos (id, nombre, id_provincia, id_departamento)
VALUES ('010101', 'Chachapoyas', '0101', '01'),
...
INSERT INTO distritos (id, nombre, id_provincia, id_departamento)
VALUES ('150501', 'San Vicente de Cañete', '1505', '15'),
    ('150502', 'Asia', '1505', '15'),
...
create table hora_subasta
(
    id   int primary key auto_increment not null,
    time time                           not null
);

create table state_subasta
(
    id         int primary key auto_increment      not null,
    name       varchar(350)                        not null,
    created_at timestamp default current_timestamp not null,
...
(
    ...
    imageUrl3  varchar(350)                        not null,
    imageUrl4  varchar(350)                        not null,
    imageUrl5  varchar(350)                        not null,
    imageUrl6  varchar(350)                        not null,
    imageUrl7  varchar(350)                        not null,
    imageUrl8  varchar(350)                        not null,
    imageUrl9  varchar(350)                        not null,
    imageUrl10 varchar(350)                        not null,
    videoUrl   varchar(350)                        not null,
    created_at timestamp default current_timestamp not null,
    updated_at timestamp default current_timestamp not null
);

create table location_subasta
(
    idSubasta  int                                 not null,
...
create table vendedor_subasta
(
    id              int primary key auto_increment      not null,
    idSubasta       int                                 not null,
    nameVendedor    varchar(350)                        not null,
...
(
    ...
    dateFinish timestamp default current_timestamp not null,
    created_at timestamp default current_timestamp not null,
    updated_at timestamp default current_timestamp not null
);
...
(
    id          int primary key auto_increment      not null,
    idTypePay   int                                 not null,
    name        varchar(350)                        not null,
    image       varchar(350)                        not null,
    description varchar(350)                        not null,
    date_finish timestamp default current_timestamp not null,
    created_at  timestamp default current_timestamp not null,
    updated_at  timestamp default current_timestamp not null
);
...
alter table subasta
add unique subastaUniq (idHoraSubasta, date);
